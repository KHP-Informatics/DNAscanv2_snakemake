...
annovar_STR_variants = sys.argv[1]
temp_STR_variants = sys.argv[2]
concise_results_report = sys.argv[3]
...
os.system("tail -n +2 %s >> %s" % (temp_STR_variants,concise_results_report))
